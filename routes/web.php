...
$router->post('/restorations/{lending_id}', 'RestorationController@store'); // lending_id data dinamis agar penge,balian tertaut pada data pada data peminjamannya
...
// buat data restoration (pengambilan ) menggunakan params data lendings_id aga r data pengembalian dibuat berdasarkan data peminjaman